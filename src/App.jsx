    ...
    <div className="grid grid-cols-5 h-screen text-center">
      ...
      <div className="col-span-1 bg-zinc-800 pt-5">
        <h1 className="text-xl text-white flex text-center justify-center ">
          ...
          <button onClick={clrearHistory} className="cursor-pointer">
            <svg
      ...
      <div className="col-span-4 p-10">
        <h1 className="p-1 text-4xl bg-clip-text text-transparent bg-gradient-to-r from-pink-700 to-violet-700">
